...
?>
      ...
      <div class="grid-item item-m-4 slider-controls-caption text-align-center font-serif font-size-tiny"></div>
...
<div id="slider-holder-<?php echo $type; ?>" class="grid-row slider-holder<?php echo $active ? ' active' : '';?>">
  <div id="swiper-<?php echo $type; ?>" class="swiper-container grid-item item-s-9">
...
?>
        <div class="slide-caption text-align-center font-serif font-size-tiny"><? _e('[:en]' . $caption_en . '[:es]' . $caption_es . '[:]'); ?></div>
<?php
    }
?>
      </div>
